...
class NotificationsViewModel: ObservableObject {
    var Data: Pagination<UserNotification>
    var cancellation: AnyCancellable?
    var mNotificationsRepository: NotificationsRepository
    var mUserId: Int
    var mMaxItems: Int
    var mSkipCount: Int
    var mOrderBy: String
    ...
    init(userId: Int, maxItems: Int, skipCount: Int, orderBy: String, include: String, filter: String) {
        self.Data = Pagination<UserNotification>()
        self.mNotificationsRepository = NotificationsRepository()
        self.mUserId = userId
    ...
    public func loadData() {
        ...
        self.IsLoading = true
        self.IsError = false
        self.Data.Elements.append(UserNotification())
        self.objectWillChange.send()
        self.cancellation = self.mNotificationsRepository.loadItems(self.mUserId, self.mMaxItems, self.mSkipCount, self.mOrderBy, self.mInclude, self.mFilter)
